...
gdsc_old/mask_comb/maskcomb_train_${SLURM_ARRAY_TASK_ID}.csv \
gdsc_old/mask_comb/maskcomb_test_${SLURM_ARRAY_TASK_ID}.csv \
gdsc_old/gdsc_gene_exp.csv \
gdsc_old/gdsc_smile_random.smi \
data/2128_genes.pkl \
single_pytorch_model/smiles_language \
gdsc1_maskcomb_random \
single_pytorch_model/model_params_50.json \
"gdsc1_maskcomb_random_${SLURM_ARRAY_TASK_ID}"
