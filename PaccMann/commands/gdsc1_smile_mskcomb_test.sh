...
gdsc1_maskcomb/gdsc1_maskcomb_${SLURM_ARRAY_TASK_ID}/weights/best_mse_paccmann_v2.pt \
gdsc1_maskcomb_result_${SLURM_ARRAY_TASK_ID} \
gdsc1_maskcomb/gdsc1_maskcomb_${SLURM_ARRAY_TASK_ID}/model_params.json
