...
Drugsim_fig_mt = readmatrix('simD_Oldgdsc_pbfp.csv');
...
writematrix(results_met,'results_oldgdsc_pbfp_mask_comb.csv');
writematrix(predMatOut,'predMat_oldgdsc_pbfp_mask_comb.csv');