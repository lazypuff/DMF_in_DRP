...
Drugsim_fig_mt = readmatrix('simD_gdsc_256b.csv');
...
writematrix(results_met,'results_oldgdsc_256b_mask_comb.csv');
writematrix(predMatOut,'predMat_oldgdsc_256b_mask_comb.csv');
