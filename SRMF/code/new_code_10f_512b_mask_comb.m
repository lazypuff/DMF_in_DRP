...
Drugsim_fig_mt = readmatrix('simD_gdsc_512b.csv');
...
writematrix(results_met,'results_oldgdsc_512b_mask_comb.csv');
writematrix(predMatOut,'predMat_oldgdsc_512b_mask_comb.csv');